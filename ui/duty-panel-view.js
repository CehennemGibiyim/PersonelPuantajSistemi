...
export function renderDutySection() {
  ...
  return `<section class="advanced-section"><h3>${t('advanced.dutyTitle')}</h3>
    ...
    <div class="advanced-form-grid">
      <select class="modal-input" id="dutyPerson" aria-label="${t('advanced.selectPerson')}"${locked ? ' disabled' : ''}>${personOptions()}</select>
      <input class="modal-input" id="dutyDay" type="number" min="1" max="${getDaysInMonth()}" placeholder="${t('advanced.day')}" aria-label="${t('advanced.day')}"${locked ? ' disabled' : ''}>
      <select class="modal-input" id="dutyType" aria-label="${t('advanced.dutyType')}"${locked ? ' disabled' : ''}>
      ...
      <input class="modal-input" id="dutyHours" type="number" min="0" max="24" value="16" placeholder="${t('advanced.grossHours')}" aria-label="${t('advanced.grossHours')}"${locked ? ' disabled' : ''}>
      <input class="modal-input" id="dutyNight" type="number" min="0" max="24" value="8" placeholder="${t('advanced.nightHours')}" aria-label="${t('advanced.nightHours')}"${locked ? ' disabled' : ''}>
      <input class="modal-input" id="dutyExtra" type="number" min="0" max="24" value="8" placeholder="${t('advanced.extraHours')}" aria-label="${t('advanced.extraHours')}"${locked ? ' disabled' : ''}>
      <input class="modal-input" id="dutyHoliday" type="number" min="0" max="24" value="0" placeholder="${t('advanced.holidayHours')}" aria-label="${t('advanced.holidayHours')}"${locked ? ' disabled' : ''}>
    </div>
    <input class="modal-input" id="dutyNote" placeholder="${t('advanced.notePlaceholder')}" aria-label="${t('advanced.notePlaceholder')}"${locked ? ' disabled' : ''}>
    <button class="btn btn-primary" id="dutyAddBtn"${locked ? ' disabled' : ''}>${t('advanced.addDuty')}</button>
